...
# df
# 
# write.csv(df, file = "exp2_raw.csv", row.names = FALSE, fileEncoding = "UTF-8")
# 
...
# 读取原始数据
df <- read.csv("exp2_raw.csv", fileEncoding = "UTF-8")
...
df_rt_diff_diff <- df_rt_diff %>%
  ...
  dplyr::mutate(
    diff_dfff_SF_match = TR_diff_SF_Match - TIR_diff_SF_Match,
    diff_dfff_SStr_match = TR_diff_SStr_Match - TIR_diff_SStr_Match,
    diff_dfff_FStr_match = TR_diff_FStr_Match - TIR_diff_FStr_Match,
    diff_dfff_SF_nonmatch = TR_diff_SF_NonMatch - TIR_diff_SF_NonMatch,
    diff_dfff_SStr_nonmatch = TR_diff_SStr_NonMatch - TIR_diff_SStr_NonMatch,
    diff_dfff_FStr_nonmatch = TR_diff_FStr_NonMatch - TIR_diff_FStr_NonMatch
  ) %>%
  dplyr::select(diff_dfff_SF_match, diff_dfff_SStr_match, diff_dfff_FStr_match, diff_dfff_SF_nonmatch, diff_dfff_SStr_nonmatch, diff_dfff_FStr_nonmatch) 
...
df_sdt_diff_diff <- df_sdt_diff %>%
  ...
  dplyr::mutate(
    diff_dfff_SF_dprm = TR_diff_SF_dprm - TIR_diff_SF_dprm,
    diff_dfff_SStr_dprm = TR_diff_SStr_dprm - TIR_diff_SStr_dprm
  ) %>%
  dplyr::select(diff_dfff_SF_dprm, diff_dfff_SStr_dprm) 
